...
while True:
    token = input(
        f'{Style.BRIGHT}{Fore.WHITE}Enter your token to proceed{Style.RESET_ALL}{Fore.RESET}\n >'
    )
    guild_s = input(
        f'{Style.BRIGHT}{Fore.WHITE}Enter the ID of the server you wish to replicate{Style.RESET_ALL}{Fore.RESET}\n >'
    )
    guild = input(
        f'{Style.BRIGHT}{Fore.WHITE}Enter the ID of the destination server to paste the copied server{Style.RESET_ALL}{Fore.RESET}\n>'
    )
    clearall()
    ...
    confirm = input(
        f'{Style.BRIGHT}{Fore.WHITE}Are the values correct? {Fore.YELLOW}(Y/N){Style.RESET_ALL}{Fore.RESET}\n >'
    )
    if confirm.upper() == 'Y':
